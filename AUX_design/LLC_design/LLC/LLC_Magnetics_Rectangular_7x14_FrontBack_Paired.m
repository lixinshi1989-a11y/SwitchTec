...
% All leads exit +X as before. Only outer/start leads bend in Y outside spirals.
...
%% Area-sweep plots
outDir=fullfile(fileparts(mfilename('fullpath')),'output','secondary_frontback_paired_1mm');
...
for k=1:4
    ...
    add_path([q(1,:);q(1,1) pairedY;30 pairedY],layer,k+1);
