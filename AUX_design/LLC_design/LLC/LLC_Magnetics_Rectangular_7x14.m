%% LLC planar transformer - 7 x 14 mm rectangular centre-leg redesign
...
fprintf('AEDT primary-referred leakage at 800 kHz: %.3f uH\n', ...
...
secondaryInnerRight=legCenter+halfX+2+P.ws*0.5e3;
viaX=secondaryInnerRight-[2.45 0.95 0.95 2.45];
secondaryInnerBottom=-(halfY+2+P.ws*0.5e3);
returnY=secondaryInnerBottom+[-0.90 0.10 0.10 -0.90];
