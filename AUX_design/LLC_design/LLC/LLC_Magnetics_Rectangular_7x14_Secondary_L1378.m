%% LLC 7x14: secondary L1/L3/L6/L8, inner-end returns L2/L7
...
%% Area-sweep plots
outDir=fullfile(fileparts(mfilename('fullpath')),'output','secondary_L1378');
...
for k=1:4
    ...
    add_path([q(1,:);30 q(1,2)],layer,k+1);
