"""Solve the 7 x 14 mm, 0.5 mm core-clearance rectangular LLC model."""
...
PROJECT = ROOT / "output" / "LLC_Rectangular_7x14_Clearance0p5_PSgap4p6_800kHz.aedt"
OUT = ROOT / "output" / "LLC_rectangular_7x14_gap4p6_results"
...
def main(solve=True):
    ...
    try:
        ...
        text = (
            "AEDT rectangular 7 x 14 mm LLC, 0.5 mm core-PCB clearance\n"
            "Frequency_Hz=800000\n"
            "CoreLength_mm=30\n"
            "LegWidth_mm=7\n"
            "LegDepth_mm=14\n"
            "CoreToPCBClearance_mm=0.5\n"
            "WindingCentreSpacing_mm=23\n"
            "PSCopperGap_mm=4.6\n"
        ...
        result_file = OUT / "LLC_rectangular_7x14_gap4p6_leakage_800kHz.txt"
        result_file.write_text(text, encoding="utf-8")
        data.export_data_to_csv(str(OUT / "LLC_rectangular_7x14_gap4p6_matrix.csv"))
