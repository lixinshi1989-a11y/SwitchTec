...
# Pair terminals at the left/right secondary winding outline.
SEC_PORT_GAP = 1.0
...
# Inner ends return alongside their own outer/start terminal on L2/L7.
...
oProject.SaveAs(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'output', 'LLC_7x14_Secondary_GroupedTerminals_1mm_Geometry.aedt'), True)
