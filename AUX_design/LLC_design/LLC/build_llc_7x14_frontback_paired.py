...
All leads retain the original +X exit direction. Only the start breakout
is bent outside the winding outline to approach its own unchanged return.
S1/S4: y=-7.65/-9.35 mm. S2/S3: y=+7.65/+9.35 mm.
Original winding geometry, vias, core, stack and primary are unchanged.
...
STEM = "LLC_7x14_Secondary_FrontBack_Paired1mm"
...
for layer, winding in SECONDARY_LAYERS.items():
    ...
    create_trace(winding + "_START_LEAD",
                 [start_pt, (start_pt[0], paired_y, start_pt[2]),
                  (29.0, paired_y, start_pt[2])],
