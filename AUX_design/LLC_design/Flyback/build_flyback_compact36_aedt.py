...
project=os.path.join(output,"Flyback_36_3_2_Compact70mm_3Parallel_100kHz.aedt")
oProject.SaveAs(project,True)
with open(os.path.join(output,"Flyback_36_3_2_Compact70mm_geometry.json"),"w") as f:
    json.dump(dict(project=project,half_height_mm=HEIGHT,gap_each_mm=GAP,
       ...
       stage="primary L2-L3 series; secondary L6/L7/L8 parallel with external copper bridges; AUX interconnects and excitations not assigned",
